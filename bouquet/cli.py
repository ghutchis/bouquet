...
def main():
    ...
    if args.conformer_file is not None:
        ...
        logger.info(
            f"Loaded {len(initial_conformers)} conformers from {args.conformer_file}"
        )
    ...
    if args.energy == "ani":
        ...
        calc = Psi4(
            method="b97-d3bj", basis="def2-svp", num_threads=4, multiplicity=1, charge=0
        )
    else:
